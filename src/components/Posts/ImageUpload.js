 	...
 	<div className="imageupload">
        ...
        <div style={modalStyle} className={classes.paper}>
     		<form className="imageupload__commentAssign">
     			...
     			<div className="imageupload__secondSectionModal">
     				<Avatar className="imageupload__avatar" alt="avatar" />
     				<input type= "text"
     			...
     			<div className="imageupload__imageuploadModal" onClick={uploadFileWithClick}>
     				<img src="https://image.flaticon.com/icons/svg/3233/3233027.svg" className="imageupload__gallery" alt=""/> 
     				<input type= "file"
     				className = "imageFile"
      ...
      <div className="imageupload__container">
      	...
      	<div className="imageupload__secondSection"> 
      		<Avatar className="imageupload__avatar" 
      		alt="" />
      		<input type= "text"
     		onClick={handleOpen}
     		placeholder={`What's on your mind ${username}`} />
      	...
      	<hr />
      	<div className="uploadimage__option" onClick={setOpen}>
